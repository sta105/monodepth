...
def bilinear_warp_depth_sampler(pose ,intrinsics, input_images, depth, wrap_mode='border', name='bilinear_sampler', **kwargs):


    def _warp(pose,intrinsics ,input_images, depth)
    ...
    def _projective_inverse_warp(img, depth, pose, intrinsics):
    ...
    with tf.variable_scope(name):
        ...
        output = _projective_inverse_warp(pose, intrinsics ,input_images, depth)
        return output